...
const weatherCodeMap = {
  ...
  71: { weather: '약한 눈', icon: 'bi-cloud-snow', color: 'light' },
  73: { weather: '눈', icon: 'bi-cloud-snow', color: 'light' },
  75: { weather: '강한 눈', icon: 'bi-cloud-snow', color: 'light' },
  77: { weather: '싸락눈', icon: 'bi-cloud-snow', color: 'light' },
  ...
  85: { weather: '눈보라', icon: 'bi-cloud-snow', color: 'light' },
  86: { weather: '강한 눈보라', icon: 'bi-cloud-snow', color: 'light' },
